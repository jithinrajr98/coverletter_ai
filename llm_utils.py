...
def translation_prompt(text: str, target_language: str = "French", content_type: str = "cover letter") -> str:
    ...
    if content_type == "profile":
        ...
        additional_context = "This is a CV/resume profile section that should maintain its professional impact and technical terminology."
    else:
        instruction = f"Translate the following professional {content_type} to {target_language}."
        additional_context = f"This is a professional {content_type} that should maintain formal business correspondence standards."
